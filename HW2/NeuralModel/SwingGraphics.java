...
public class SwingGraphics extends JPanel {
    ...
    public static void main(String[] args){
        ...
        //SwingGraphics sg = new SwingGraphics();

        // create instances of the Neuron classes
//        Perceptron p = new Perceptron(new double[] {0.5, 0.5}, 1.0);
//        SigmoidNeuron s = new SigmoidNeuron(new double[] {1.0, -1.0}, 0.0);
//        RectifiedLinearUnit r = new RectifiedLinearUnit();

        // plot the output of the neurons
        double[] x = new double[] {0.0, 1.0};
//        double[] y1 = new double[] {p.getOutput(x), s.getOutput(x), r.getOutput(x)};
//        double[] y2 = new double[] {p.getOutput(new double[] {1.0, 0.0}), s.getOutput(new double[] {1.0, 0.0}), r.getOutput(new double[] {1.0, 0.0})};
//        double[] y3 = new double[] {p.getOutput(new double[] {1.0, 1.0}), s.getOutput(new double[] {1.0, 1.0}), r.getOutput(new double[] {1.0, 1.0})};

//        grapher.graph(x, y1, Color.RED);
//        grapher.graph(x, y2, Color.GREEN);
//        grapher.graph(x, y3, Color.BLUE);
