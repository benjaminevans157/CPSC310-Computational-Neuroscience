...
public class ToolPaint extends Application {
    ...
    public void start(Stage stage) throws Exception{
        ...
        //Bottom Menu 
        Button prevImage = new Button("Previous Image");
        Button nextImage = new Button("Next Image");
        Text fileNameText = new Text("Insert File Name");
        Button save = new Button("Save");
        imageLabel = new Label();
     
        //Bottom HBOX menu adding
        HBox bottomMenuBox = new HBox();
        bottomMenuBox.getChildren().add(prevImage);
        bottomMenuBox.getChildren().add(nextImage);
        bottomMenuBox.getChildren().add(imageLabel);
        bottomMenuBox.getChildren().add(save);

        bottomMenuBox.setSpacing(20);
    		bottomMenuBox.setAlignment(Pos.TOP_CENTER);
    		
        root.setBottom(bottomMenuBox);
        
        //setOnActions for the bottom menu
        currImage =1;
        doOpenImage();
        save.setOnAction( e -> doSaveImage(currImage) );
        nextImage.setOnAction( e -> doNextImage() );
        prevImage.setOnAction(e -> doPrevImage() );

        //BufferedImage currImageBuff = ImageIO.read(new File("batch1_image_Page_01.png"));
    	
        //set on mouse clicked for each of the buttons
        //hardcode the locations for the files for prevImage and nextImage
        doOpenImage();
        //canvasGraphics.drawImage(new Image("batch1_image_Page01.png"),0,0,canvas.getWidth(),canvas.getHeight());
        stage.setScene( new Scene(root) );
        stage.setTitle("EyeWire Light");
    ...
    private MenuBar makeMenuBar() {
        ...
        saveImage.setOnAction( e -> doSaveImage(currImage) );
    ...
    private void doOpenImage() {
      //String imagePath = "/batch1_image_Page_" + String.format("%02d", currImage) + ".png";
      //System.out.println(imagePath);
      //Image image = new Image(imagePath);
      
      String filename = "batch1_image_Page_" + String.format("%02d", currImage) + ".png";
      String directory = "/afs/afs.hws.edu/home/be8584/cs329/workspace/EyeWire310/src/images";
      File imageFile = new File(directory, filename);
      String imagePath = imageFile.toURI().toString();

      System.out.println(imagePath);
      Image image = new Image(imagePath);
      //Image image = new Image("/images/batch1_image_Page_01.png");
      if (image.isError()) {
      ...
      imageLabel.setText("Image: batch1_image_Page" + String.format("%02d", currImage) + ".png");
  }

    /**
     * Saves the user's sketch as an image file in PNG format.
     */
    private void doSaveImage(int currImage) {
